...
- **Evidence:**
    ...
    ```
    ```
    /home/workspace/astrology/residual_model.py:36:    def __init__(self, mode: str = "physics"):
    ```
...
- **Evidence:**
    ...
    ```
    ```
    /home/workspace/home-cluster-iac/failure_orchestrator/orchestrator.py:148:                    f"Failure detected [{name}]: {reason} → attempt {attempt}/{engine.MAX_RETRIES} (backoff={backoff}s)"
    ```
...
- **Evidence:**
    ```
    /home/workspace/graphify-out/healthcheck.py:67:        r = subprocess.run(['python3', 'graphify-out/infer_edges.py'],
    ```
    ```
    /home/workspace/graphify-out/healthcheck.py:110:    r = subprocess.run(['python3', 'graphify-out/recall_test.py', '-n', '5'],
    ```
    ```
...
- **Evidence:**
    ...
    ```
    ```
    /home/workspace/atom-federation-os/build/lib/formal_model/execution_equivalence/ledger_normalizer.py:158:            "reason": f"length mismatch: EG={len(norm_eg)} vs FEG={len(norm_feg)}",
    ```
...
- **Evidence:**
    ...
    ```
    ```
    /home/workspace/meta_rl/quant/metrics.py:54:    """Rolling Sharpe ratio (annualized)."""
    ```
...
- **Evidence:**
    ...
    ```
    ```
    /home/workspace/home-cluster-iac/acos_correction/rca_engine.py:214:                    "file": "failure_orchestrator/recovery.py",
    ```
    ```
...
- **Evidence:**
    ...
    ```
    ```
    /home/workspace/tests/test_risk_integration.py:37:    engine._equity_history = [100_000.0]
    ```
    ```
    /home/workspace/tests/test_risk_integration.py:38:    return engine
    ```
...
- **Evidence:**
    ...
    ```
    ```
    /home/workspace/home-cluster-iac/v6/constraint_engine/engine.py:173:        # Placeholder: real impl would query network state
    ```
...
- **Evidence:**
    ...
    ```
    ```
    /home/workspace/meta_rl/replay.py:91:    Returns OAPDriftReport with severity, evidence, and recommendations.
    ```
    ```
    /home/workspace/meta_rl/replay.py:116:        severity = "none"
    ```
