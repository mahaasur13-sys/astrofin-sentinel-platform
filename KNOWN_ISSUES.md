...
**Symptom**: 41 unit tests fail on `master` (commit `ea19d8b`, tag `v1.0.0`)
across 15 files. Failure categories:
...
`SKIP_LIST_KI_125A` (41 entries). The skip is fully reversible — remove
