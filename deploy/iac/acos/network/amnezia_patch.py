...
def validate_network_requirements(
    dag: dict, tunnel_manager: AmneziaWGManager
...
def patch_engine_pre_execute(
    engine_self, dag: dict, context: dict, trace_id: str
) -> bool:
    """
...
def create_tunnel_incident(
    incident_manager, trace_id: str, node_id: str, error: str
) -> None:
    """
