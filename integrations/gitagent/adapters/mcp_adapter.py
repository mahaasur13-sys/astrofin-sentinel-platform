...
class MCPAdapter:
    ...
    def _get_fallback_servers(self, query: str) -> list[dict[str, Any]]:
        ...
        fallback_db = {
            "github": [
                {"name": "@smithery/github", "description": "GitHub API integration for code, issues, PRs", "category": "development"},
                {"name": "@modelcontextprotocol/server-github", "description": "GitHub MCP server", "category": "development"},
            ],
            "filesystem": [
                {"name": "@smithery/filesystem", "description": "Local filesystem operations", "category": "system"},
                {"name": "@modelcontextprotocol/server-filesystem", "description": "Filesystem MCP server", "category": "system"},
            ],
            "search": [
                {"name": "@modelcontextprotocol/server-brave-search", "description": "Web search capabilities", "category": "search"},
                {"name": "@smithery/brave-search", "description": "Brave Search API integration", "category": "search"},
            ],
            "slack": [
                {"name": "@modelcontextprotocol/server-slack", "description": "Slack messaging integration", "category": "communication"},
                {"name": "@smithery/slack", "description": "Slack API MCP server", "category": "communication"},
            ],
            "postgres": [
                {"name": "@modelcontextprotocol/server-postgres", "description": "PostgreSQL database access", "category": "database"},
                {"name": "@smithery/postgres", "description": "PostgreSQL MCP server", "category": "database"},
            ],
            "finance": [
                {"name": "yahoo-finance-mcp", "description": "Yahoo Finance data (stocks, crypto, options)", "category": "financial"},
            ...
            "calendar": [
                ...
                {"name": "@modelcontextprotocol/server-google-calendar", "description": "Google Calendar MCP", "category": "calendar"},
            ],
            "postgres": [
                {"name": "@modelcontextprotocol/server-postgres", "description": "PostgreSQL database access", "category": "database"},
            ],
            "memory": [
                {"name": "@modelcontextprotocol/server-memory", "description": "Persistent memory storage", "category": "system"},
            ],
        }
