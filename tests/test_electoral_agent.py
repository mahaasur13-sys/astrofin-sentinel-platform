"""
tests/test_electoral_agent.py
============================

BlackRock six-test contract for ElectoralAgent.
...
from agents._impl.electoral_agent import ElectoralAgent  # noqa: E402


class TestElectoralAgentBlackRock(AgentTestContract, DegradedContract):
    """BlackRock six-test contract for ElectoralAgent."""

    agent_class = ElectoralAgent
