"""BlackRock six-test contract for agents._impl.electoral_agent.

Electoral astrology — political cycle positioning.
...
from agents._impl import electoral_agent as _mod  # noqa: E402
