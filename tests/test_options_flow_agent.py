"""BlackRock six-test contract for agents._impl.options_flow_agent.

Options flow / dealer gamma exposure.
...
from agents._impl import options_flow_agent as _mod  # noqa: E402
