...
collect_ignore_glob = [
    ...
    # Backtest with real Binance fetch hangs/451 in sandboxed CI where
    # api.binance.com is unreachable or legally blocked. The test is
    # preserved in source for future restoration once the offline-data
    # fixture is wired into BacktestEngine.
