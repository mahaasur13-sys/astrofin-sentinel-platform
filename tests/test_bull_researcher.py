"""BlackRock six-test contract for agents._impl.bull_researcher.

Bull case research agent — long thesis + confirmation.
...
from agents._impl import bull_researcher as _mod  # noqa: E402
