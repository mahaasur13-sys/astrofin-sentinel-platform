"""BlackRock six-test contract for agents._impl.synthesis_agent.

Synthesis — final aggregator before Council.
...
from agents._impl import synthesis_agent as _mod  # noqa: E402
