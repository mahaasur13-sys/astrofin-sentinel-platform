"""BlackRock six-test contract for agents._impl.elliot_agent.

Elliott Wave count — impulse/correction structure.
...
from agents._impl import elliot_agent as _mod  # noqa: E402
