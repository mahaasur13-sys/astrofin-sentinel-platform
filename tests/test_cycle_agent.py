"""BlackRock six-test contract for agents._impl.cycle_agent.

Cycle theory (周期) — long/short temporal cycles.
...
from agents._impl import cycle_agent as _mod  # noqa: E402
