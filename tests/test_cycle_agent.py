"""
tests/test_cycle_agent.py
============================

BlackRock six-test contract for CycleAgent.
...
from agents._impl.cycle_agent import CycleAgent  # noqa: E402


class TestCycleAgentBlackRock(AgentTestContract, DegradedContract):
    """BlackRock six-test contract for CycleAgent."""

    agent_class = CycleAgent
