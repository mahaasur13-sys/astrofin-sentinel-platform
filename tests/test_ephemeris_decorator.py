"""BlackRock six-test contract for agents._impl.ephemeris_decorator.

Ephemeris decorator — Swiss Ephemeris availability guard.
...
from agents._impl import ephemeris_decorator as _mod  # noqa: E402
