"""BlackRock six-test contract for agents._impl.market_analyst.

Top-level market analyst — regime classification.
...
from agents._impl import market_analyst as _mod  # noqa: E402
