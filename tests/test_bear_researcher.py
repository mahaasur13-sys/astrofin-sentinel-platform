"""BlackRock six-test contract for agents._impl.bear_researcher.

Bear case research agent — contrarian short thesis.
...
from agents._impl import bear_researcher as _mod  # noqa: E402
