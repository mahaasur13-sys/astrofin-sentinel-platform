"""BlackRock six-test contract for agents._impl.insider_agent.

Insider wallet / smart-money flow tracker.
...
from agents._impl import insider_agent as _mod  # noqa: E402
