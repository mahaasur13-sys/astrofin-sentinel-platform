...
BlackRock six-test contract for InsiderAgent.
...
from agents._impl.insider_agent import InsiderAgent  # noqa: E402


class TestInsiderAgentBlackRock(AgentTestContract, DegradedContract):
    """BlackRock six-test contract for InsiderAgent."""

    agent_class = InsiderAgent
