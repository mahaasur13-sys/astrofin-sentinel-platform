...
def _on_test_stop(environment, **kwargs):
    ...
    print(f"[locust] done — total={stats.total.num_requests} failures={stats.total.num_failures} p95={stats.total.get_response_time_percentile(0.95):.0f} ms rps={stats.total.total_rps:.1f}")
