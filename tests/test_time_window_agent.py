"""BlackRock six-test contract for agents._impl.time_window_agent.

Astro time windows — aspect strength windows.
...
from agents._impl import time_window_agent as _mod  # noqa: E402
