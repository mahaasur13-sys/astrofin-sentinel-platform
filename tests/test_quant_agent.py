"""BlackRock six-test contract for agents._impl.quant_agent.

Quant signals — momentum, mean-reversion, vol.
...
from agents._impl import quant_agent as _mod  # noqa: E402
