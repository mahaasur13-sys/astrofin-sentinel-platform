"""BlackRock six-test contract for agents._impl.technical_agent.

Classical technicals — RSI, MACD, S/R.
...
from agents._impl import technical_agent as _mod  # noqa: E402
