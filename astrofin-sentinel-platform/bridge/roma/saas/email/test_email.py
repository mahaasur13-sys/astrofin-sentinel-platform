...
from saas.email.service import EmailProvider, EmailService
...
def test_no_cross_contamination():
    ...
    _html2 = svc2._render("welcome", tenant_name="Beta", api_key="key2", brand=b2, dashboard_url="https://b.com")
    ...
    log.info("PASS: no_cross_contamination")
...
def test_templates_render():
    ...
    log.info("PASS: templates_render")
