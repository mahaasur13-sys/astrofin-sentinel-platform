...
class TestEventLog(unittest.TestCase):
    ...
    def test_verify_chain_with_gap(self):
        ...
        e = Event(
            trace_id="t",
            event_type=EventType.DAG_CREATED,
            payload={},
            prev_hash="WRONG",
        )
...
class TestReducerEdgeCases(unittest.TestCase):
    ...
    def test_governance_rejected(self):
        ...
        self.assertEqual(
            StateReducer(log).rebuild("t")["governance_decision"], "REJECTED"
        )
...
class TestSecurity(unittest.TestCase):
    def test_systemd_hardening(self):
        with open(
            "/home/workspace/home-cluster-iac/systemd/acos-tunnel-monitor.service"
        ) as f:
            c = f.read()
    ...
    def test_grafana_no_plaintext(self):
        with open(
            "/home/workspace/home-cluster-iac/observability/docker-compose.yml"
        ) as f:
            c = f.read()
