"""BlackRock six-test contract for agents._impl.ml_predictor_agent.

ML predictor — gradient-boosted short-term forecast.
...
from agents._impl import ml_predictor_agent as _mod  # noqa: E402
