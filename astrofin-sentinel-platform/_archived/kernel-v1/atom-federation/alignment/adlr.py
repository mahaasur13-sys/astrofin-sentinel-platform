...
class RecoveryPolicy:
    ...
    _TYPE_MAP = {
        ...
        "LEADER_UNIQUENESS": ("ensure_single_leader", "CCL", {}),
        "VERSION_CLOCK_DIVERGENCE": ("sync_version_vectors", "DRL", {}),
    }

    def recover(self, scenario):  # noqa: F821 -> RecoveryActionObj | None:
        """Map failure_type → RecoveryActionObj with target layer and params."""
