...
SCENARIOS: dict[str, StressScenario] = {
    ...
    "sustained": StressScenario(
        name="sustained", profile=sustained_overload(), duration_sec=1800
    ),
    "adversarial": StressScenario(
        name="adversarial", profile=adversarial_scheduling(), duration_sec=600
    ),
    "hotspot": StressScenario(
        name="hotspot", profile=skewed_hotspot(), duration_sec=300
    ),
    "failure": StressScenario(
        name="failure", profile=cascading_failure(), duration_sec=300
    ),
    "baseline": StressScenario(
        name="baseline", profile=normal_baseline(), duration_sec=600
    ),
}
