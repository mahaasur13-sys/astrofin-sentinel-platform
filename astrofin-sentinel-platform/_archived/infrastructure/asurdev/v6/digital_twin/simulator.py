...
class DigitalTwin:
    ...
    def simulate_batch(
        ...
        return [self.simulate(initial_state, a, ml_predictions, horizon_minutes) for a in actions]
    ...
    def evaluate_action(
        ...
        """
        final_state = self.simulate(initial_state, action, ml_predictions, horizon_minutes)
        return {
            ...
            "expected_utility": final_state.total_throughput - 10.0 * final_state.cluster_failure_prob,
        }
