...
class TestStateVectorBasics:
    ...
    @pytest.mark.xfail(reason='C1: deterministic tick-based timestamp=0', strict=False)
...
class TestStateVectorAge:
    ...
    @pytest.mark.xfail(reason='C1: is_stale uses wall-clock ticks, fails with deterministic 0', strict=False)
