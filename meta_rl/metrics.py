...
STRATEGIES_CREATED = _safe(Counter, "astrofin_strategies_created", "Total strategies created")
GENERATIONS_TOTAL = _safe(Counter, "astrofin_generations_total", "Total number of generations")
