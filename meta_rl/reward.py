...
class RewardCalculator:
    ...
    def compute(self, result: EvaluationResult) -> float:
        ...
        try:
            ...
            # If adjusted_drawdown not explicitly set (None or 0), fall back to max_drawdown.
            if result.adjusted_drawdown is not None and result.adjusted_drawdown > 0.0:
                adj_dd = result.adjusted_drawdown
            else:
                adj_dd = result.max_drawdown
