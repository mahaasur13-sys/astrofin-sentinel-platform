...
class RCAEngine:
    ...
    def run_scenario(self, scenario_name: str) -> dict:
        ...
        module_path = os.path.join(self.repo_root, "load_test", "scenarios", scenario_name, "test.py")
    ...
    def analyze(self, scenario_name: str, scenario_result: dict) -> RCAResult:
        ...
        affected_layer, cause_type = layer_map.get(scenario, ("unknown", CauseType.STOCHASTIC))
