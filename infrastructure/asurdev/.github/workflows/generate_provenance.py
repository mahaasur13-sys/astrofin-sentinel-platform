...
oidc_subject = os.environ.get(
    "OIDC_SUBJECT",
    "https://github.com/mahaasur13-sys/AsurDev/.github/workflows/slsa4-live.yml@refs/heads/main",
)
...
prov = {
    ...
    "predicate": {
        "buildDefinition": {
            ...
            "externalParameters": {
                "repository": repo,
                "workflow": "SLSA-4 Live Supply Chain Enforcement",
            },
        ...
        "runDetails": {
            "builder": {
                "id": f"https://github.com/{repo}/attestations/node@v1",
                "OODR": {
