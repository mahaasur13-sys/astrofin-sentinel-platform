...
class Job:
    ...
    def is_terminal(self) -> bool:
        return self.status in (JobStatus.COMPLETED, JobStatus.COMMITTED, JobStatus.DEAD, JobStatus.FAILED)

    def is_retryable(self) -> bool:
        return self.retry_count < self.max_retries and self.status in (JobStatus.FAILED, JobStatus.DEAD)
