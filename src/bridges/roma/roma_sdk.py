...
class ROMAClient:
    ...
    def submit(self, task: str, *, gpu_required: bool = False, priority: int = 5, execution_mode: str = "k8s_job") -> ROMAJob:
        ...
        data = resp.json()
        return ROMAJob(job_id=data["job_id"], status=data["status"], queue_priority=data["roma_dispatch"]["queue_priority"], dag=data["dag"], estimated_resources=data["estimated_resources"])
