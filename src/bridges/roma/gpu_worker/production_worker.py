...
class ExecutionResult:
    def __init__(self, success: bool, output: Optional[dict] = None, error: Optional[str] = None, duration_ms: float = 0.0):
    ...
    def run_iteration(self) -> bool:
        ...
        try:
            ...
            if result.success:
                ...
                self.observability.record_job_result(job.job_id, worker.worker_id, False, result.duration_ms, result.error)
...
"""
    ...
    def get_deployment_command(control_plane: str, worker_id: str, memory_gb: int = 8, cpus: int = 4) -> str:
        return GPUWorkerDeployment.DOCKER_TEMPLATE.format(memory_limit=memory_gb, cpus=cpus, control_plane=control_plane, worker_id=worker_id)
