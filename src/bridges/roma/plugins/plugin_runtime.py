...
class PluginRuntime:
    ...
    def list_loaded(self) -> List[Dict]:
        return [{"name": k, "version": str(v.spec.version), "phase": v.phase, "executions": v.execution_count, "errors": v.error_count} for k, v in self._loaded.items()]
...
def main():
    ...
    task2 = type("Task", (), {"task_id": "task-002", "plugin_name": "inference", "payload": {"model": "llama3-8b"}, "metadata": {}, "fingerprint": "x"})()
