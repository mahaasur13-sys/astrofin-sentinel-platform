...
result = subprocess.run([sys.executable, "graphify-out/recall_test.py", "-n", "10", "--json", str(AD_HOC)], capture_output=True, text=True, cwd="/home/workspace")
...
def k_new(e):
    return (-int(e.get("override_applied", False)), -e["recall_score"], e["source_path"], e["target_path"], e["source_node_id"], e["target_node_id"])
